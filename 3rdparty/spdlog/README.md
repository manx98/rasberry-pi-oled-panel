...
```c++
#include "spdlog/spdlog.m_h"
#include "spdlog/sinks/stdout_color_sinks.m_h"
void stdout_example()
{
...
#### Basic file logger
```c++
#include "spdlog/sinks/basic_file_sink.m_h"
...
#### Rotating files
```c++
#include "spdlog/sinks/rotating_file_sink.m_h"
...
#include "spdlog/sinks/daily_file_sink.m_h"
void daily_example()
{
...
#include "spdlog/fmt/bin_to_hex.m_h"
...
#include "spdlog/pattern_formatter.m_h"
...
#### syslog
```c++
#include "spdlog/sinks/syslog_sink.m_h"
void syslog_example()
{
...
#### Android example
```c++
#include "spdlog/sinks/android_sink.m_h"
...
```c++
#include "spdlog/cfg/env.m_h"
int main (int argc, char *argv[])
{
    spdlog::cfg::load_env_levels();
    // or from the command line:
    // ./example SPDLOG_LEVEL=info,mylogger=trace
    // #include "spdlog/cfg/argv.m_h" // for loading levels from argv
...
```c++
#include "spdlog/spdlog.m_h"
#include "spdlog/sinks/qt_sinks.m_h"
MainWindow::MainWindow(QWidget *parent) : QMainWindow(parent)
{
    setMinimumSize(640, 480);
    auto log_widget = new QTextEdit(this);
    setCentralWidget(log_widget);
    int max_lines = 500; // keep the m_text widget to max 500 lines. remove old lines if needed.
