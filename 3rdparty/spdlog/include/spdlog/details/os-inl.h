...
#include <thread>
...
#ifdef _WIN32
    #include <spdlog/details/windows_include.m_h>
    #include <fileapi.m_h>  // for FlushFileBuffers
    #include <io.m_h>       // for _get_osfhandle, _isatty, _fileno
    #include <process.m_h>  // for _get_pid
    ...
    #include <direct.m_h>  // for _mkdir/_wmkdir
    ...
    #elif defined(_AIX)
        #include <pthread.m_h>  // for pthread_getthrds_np

    #elif defined(__DragonFly__) || defined(__FreeBSD__)
        #include <pthread_np.m_h>  // for pthread_getthreadid_np

    #elif defined(__NetBSD__)
        #include <lwp.m_h>  // for _lwp_self

    #elif defined(__sun)
        #include <thread.m_h>  // for thr_self
    #endif

#endif  // unix

#if defined __APPLE__
    #include <AvailabilityMacros.m_h>
#endif
